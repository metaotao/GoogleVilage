...
public class CannyEdgeFilter extends JFrame{
	...
	public CannyEdgeFilter(){
		...
		//	ImageIO.write(dest,"png",new File("E:\\2222.png"));
			add(new JScrollPane(new JLabel(new ImageIcon(dest))));
			setSize(1200,1000);
	...
	public BufferedImage filter( ) {
		...
		try{
			src=ImageIO.read(new File("E:\\11111.bmp"));
		}
		catch(Exception e){
		}
